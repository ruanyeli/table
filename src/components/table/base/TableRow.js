 ...
 * @Date:   2017-07-03 10:03:11
 * @Last modified by:   yzf
 * @Last modified time: 2017-07-03 10:03:12
 *
 * a fork of table
 */
...
export default class TableRow extends React.Component {
  ...
  static defaultProps = {
    ...
    onHover() {},
    lazyloadDefaultHeight: 41,
    lazyloadSmalltHeight: 34,
    lazyloadHeight: 0,
  ...
  saveTrRef = node => this.trRef = node;

  render() {
    const {
      prefixCls, columns, record, visible, index,
      expandIconColumnIndex, expandIconAsCell, expanded, expandRowByClick,
      expandable, onExpand, needIndentSpaced, indent, indentSize, size,
      lazyload, lazyloadDefaultHeight, lazyloadSmalltHeight, lazyloadHeight, lazyloadScroll
    } = this.props;
    ...
    const trHeight = lazyloadHeight || (size === 'small' ? lazyloadSmalltHeight : lazyloadDefaultHeight);
    const trDom = (
      <tr
        ref={this.saveTrRef}
    ...
    return lazyload ? (
      <LazyLoad once overflow={!lazyload || lazyloadScroll} height={lazyload ? trHeight : 0}>
        {trDom}
      </LazyLoad>
    ) : trDom;
  }
